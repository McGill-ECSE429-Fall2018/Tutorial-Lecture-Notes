This tutorial shows how you can write acceptance using the link:https://github.com/cucumber/cucumber-jvm[Cucumber tool] in a Behaviour-Driven Development approach.
